...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/s2geography-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/s2geography-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add s2geography
# for installing globally
pixi global install s2geography
```
...
It is possible to list all of the versions of `s2geography` available on your platform:
...
```
pixi search s2geography --channel conda-forge
```
